...
//Traemos el módulo puppeteer y IMPORTANTE añadir ; en todos los require porque
...
(async () => {
    ...
    var titulo1 = await page.evaluate(() => {
         // .evaluate(cb) va a ejecutar un script dentro de la páigna y va a devoler lo que toque
    ...
    console.log(titulo1); // hacemos visible en el servidor el título (h1) de la web a la que hemos accedido
